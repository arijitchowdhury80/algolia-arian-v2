...
from core.browser.tier1_direct import fetch_direct, fetch_jina
from core.browser.tier2_stealth import fetch_stealth
from core.browser.tier3_service import fetch_browserless, fetch_scrapingbee
from core.browser.types import FetchOptions, FetchResult
...
class BrowserClient:
    ...
    async def _try_tier3(self, url: str, options: FetchOptions) -> FetchResult:
        ...
        from core.browser.types import FetchTier
