...
from server.api.middleware import add_middleware
...
_LANDING_INTAKE_HTML = STATIC_DIR / "landing_intake" / "index.html"
...
app.mount(
    ...
    StaticFiles(directory=STATIC_DIR / "landing_intake" / "assets"),
