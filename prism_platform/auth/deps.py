...
``prism_platform.auth.acl.can_user_see``), never an exception that could
...
from prism_platform.auth.acl import can_user_see
from prism_platform.config import settings
from prism_platform.db.models import Audit, SeenAssertion, User
