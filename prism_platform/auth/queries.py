...
(prism_platform/api/routers/audits.py, accounts.py) and
`GET /api/v1/acl/visible` (prism_platform/api/routers/acl.py) -- closes
...
`prism_platform.auth.acl.can_user_see`.
"""
